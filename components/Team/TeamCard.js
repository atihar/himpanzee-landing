                    ...
                    <div className="container">
                        <div className="row">
                            ...
                            <div className="col-lg-4 col-sm-6 pt-md-0 pt-4">
                                ...
                                <h4 className="mt-4">Ralph Strebel</h4>
                                <h6>Co-founder, Head of Carbon & Legal Counsel</h6>
                                <p>Ralph is a carbon mitigation expert with experience in all scales of activity, particularly with regards to large-scale forestry and agroforestry activity. He is also the chairman of the Greenhouse Gas Management Institute, a supporting organisation that is dedicated to the coordination of GHG experts and consults and teaches GHG accounting on a global basis.
                                <br/><br/> During his time at Carbon Conservation, he was responsible for all aspects of the development of all its forest carbon projects, including Minding the Carbon Store with Rio Tinto in Queensland, Australia; Ulu Masen in Aceh, Indonesia which was the first CCBA validated REDD project; Lebong in Indonesia; and achieving the validation and verification of North Pikounda REDD+ Project.  
                                <br/><br/>As the director of Greenlaw International LLC., Ralph developed the Republic of Congo's forest-based Emission Reduction Program information note, including national baselines, achieving selection to the World Bank's FCPF Carbon Fund's Pipeline and releasing $.65 million for program design.
                                </p>
                            </div>
